...
<body class="bg-gray-100 p-6">
    ...
    <div class="max-w-4xl mx-auto bg-white shadow-xl rounded-lg p-6">
        ...
        if ($state && $district) {
            ...
            $sql = "SELECT State,District,Subdistt,Name FROM VillageData WHERE Level='SUB-DISTRICT' and State = '$state' AND District = '$district' GROUP BY Subdistt ORDER BY Subdistt ASC";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<a href='villages.php?state=" . urlencode($row['State']) . "&district=" . urlencode($row['District']) . "&subdistrict=" . urlencode($row['Subdistt']) . "' class='text-blue-600 hover:underline'>View Villages</a>";
                echo "</td></tr>";
            }
